...
export class CanvasRenderer extends Disposable implements IRenderer {
    ...
    public handleSelectionChanged(
        ...
        this._runOperation((l) =>
            l.handleSelectionChanged(start, end, columnSelectMode)
        );
    ...
    private _updateDimensions(): void {
        ...
        this.dimensions.device.char.width = Math.floor(
            this._charSizeService.width * dpr
        );
        this.dimensions.device.char.height = Math.ceil(
            this._charSizeService.height * dpr
        );
        ...
        this.dimensions.css.canvas.height = Math.round(
            this.dimensions.device.canvas.height / dpr
        );
        this.dimensions.css.canvas.width = Math.round(
            this.dimensions.device.canvas.width / dpr
        );
