...
describe("SerializeAddon", () => {
    ...
    beforeEach(() => {
        ...
        (terminal as any)._core._themeService = new ThemeService(
            (terminal as any)._core.optionsService
        );
        (terminal as any)._core._selectionService = new TestSelectionService(
            (terminal as any)._core._bufferService
        );
    });
    ...
    describe("html", () => {
        it("empty terminal with selection turned off", () => {
            ...
            assert.equal(
                (output.match(/<div><span> {10}<\/span><\/div>/g) || []).length,
                2
            );
        });
        ...
        it("basic terminal with selection", async () => {
            ...
            assert.equal(
                (output.match(/<div><span>terminal<\/span><\/div>/g) || [])
                    .length,
                1,
                output
            );
        ...
        it("cells with bold styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='font-weight: bold;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with italic styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='font-style: italic;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with underline styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='text-decoration: underline;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with invisible styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='visibility: hidden;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with dim styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='opacity: 0.5;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with strikethrough styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='text-decoration: line-through;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with combined styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='text-decoration: line-through;'>nal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with color styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='color: #00ff00;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with background styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='background-color: #00ff00;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("empty terminal with default options", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /color: #000000; background-color: #ffffff; font-family: courier-new, courier, monospace; font-size: 15px;/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("empty terminal with background included", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /color: #ffffff; background-color: #000000; font-family: courier-new, courier, monospace; font-size: 15px;/g
                    ) || []
                ).length,
                1,
                output
        ...
        it("cells with custom color styling", async () => {
            ...
            assert.equal(
                (
                    output.match(
                        /<span style='color: #ffa500;'>terminal<\/span>/g
                    ) || []
                ).length,
                1,
                output
