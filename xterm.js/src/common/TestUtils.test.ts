...
export class MockBufferService implements IBufferService {
    ...
    public onResize: IEvent<{ cols: number; rows: number }> = new EventEmitter<{
        cols: number;
        rows: number;
    }>().event;
...
export class MockCoreMouseService implements ICoreMouseService {
    ...
    public onProtocolChange: IEvent<CoreMouseEventType> =
        new EventEmitter<CoreMouseEventType>().event;
    public explainEvents(events: CoreMouseEventType): {
...
export class MockCoreService implements ICoreService {
    ...
    public onRequestScrollToBottom: IEvent<void> = new EventEmitter<void>()
        .event;
    public reset(): void {}
...
export class MockOptionsService implements IOptionsService {
    ...
    public onOptionChange: IEvent<keyof ITerminalOptions> = new EventEmitter<
...
export class MockUnicodeService implements IUnicodeService {
    ...
    public wcwidth = (codepoint: number): UnicodeCharWidth =>
        this._provider.wcwidth(codepoint);
...
export class MockDecorationService implements IDecorationService {
    ...
    public onDecorationRegistered = new EventEmitter<IInternalDecoration>()
        .event;
