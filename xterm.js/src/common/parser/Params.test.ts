...
describe("Params", () => {
    ...
    it("addParam", () => {
        ...
        assert.deepEqual(
            Array.prototype.slice.call(params.params, 0, params.length),
            [1]
        );
    ...
    it("Params.fromArray --> toArray", () => {
        ...
        assert.deepEqual(Params.fromArray(data).toArray(), [
            38,
            [2, 50, 100, 150],
            5,
            6,
    ...
    it("hasSubParams / getSubParams", () => {
        ...
        assert.deepEqual(
            params.getSubParams(0),
            new Int32Array([2, 50, 100, 150])
        );
    ...
    it("getSubParamsAll", () => {
        ...
        assert.deepEqual(params.getSubParamsAll(), {
