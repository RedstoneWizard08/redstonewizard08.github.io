...
describe("XParseColor", () => {
    ...
    describe("toXColorRgb", () => {
        it("rgb:<r>/<g>/<b> scheme in 4/8/12/16 bit", () => {
            ...
            // 8 bit
            assert.equal(
                toRgbString(parseColor("rgb:00/00/00")!, 8),
                "rgb:00/00/00"
            );
            assert.equal(
                toRgbString(parseColor("rgb:ff/ff/ff")!, 8),
                "rgb:ff/ff/ff"
            );
            assert.equal(
                toRgbString(parseColor("rgb:11/22/33")!, 8),
                "rgb:11/22/33"
            );
            // 12 bit
            assert.equal(
        ...
        it("defaults to 16 bit output", () => {
            assert.equal(
                toRgbString(parseColor("rgb:1/2/3")!),
                "rgb:1111/2222/3333"
            );
            assert.equal(
                toRgbString(parseColor("rgb:11/22/33")!),
                "rgb:1111/2222/3333"
            );
            assert.equal(
