...
export const ICoreMouseService =
    createDecorator<ICoreMouseService>("CoreMouseService");
...
export const ICharsetService =
    createDecorator<ICharsetService>("CharsetService");
...
export const IOptionsService =
    createDecorator<IOptionsService>("OptionsService");
...
export const IOscLinkService =
    createDecorator<IOscLinkService>("OscLinkService");
...
export const IUnicodeService =
    createDecorator<IUnicodeService>("UnicodeService");
...
export const IDecorationService =
    createDecorator<IDecorationService>("DecorationService");
