...
export const ICharSizeService =
    createDecorator<ICharSizeService>("CharSizeService");
...
export const ICoreBrowserService =
    createDecorator<ICoreBrowserService>("CoreBrowserService");
...
export const ISelectionService =
    createDecorator<ISelectionService>("SelectionService");
...
export const ICharacterJoinerService = createDecorator<ICharacterJoinerService>(
...
export const ILinkProviderService = createDecorator<ILinkProviderService>(
    "LinkProviderService"
);
