...
export class SelectionService extends Disposable implements ISelectionService {
    ...
    private readonly _onLinuxMouseSelection = this.register(
        new EventEmitter<string>()
    );
    public readonly onLinuxMouseSelection = this._onLinuxMouseSelection.event;
    private readonly _onRedrawRequest = this.register(
        new EventEmitter<ISelectionRedrawRequestEvent>()
    );
    ...
    private readonly _onRequestScrollLines = this.register(
        new EventEmitter<ISelectionRequestScrollLinesEvent>()
    );
    ...
    constructor(
        ...
        this._mouseMoveListener = (event) =>
            this._handleMouseMove(event as MouseEvent);
        this._mouseUpListener = (event) =>
            this._handleMouseUp(event as MouseEvent);
    ...
    private _getMouseBufferCoords(
        ...
        const coords = this._mouseService.getCoords(
            event,
            this._screenElement,
            this._bufferService.cols,
    ...
    private _handleBufferActivate(e: {
