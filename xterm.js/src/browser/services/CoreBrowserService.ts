...
export class CoreBrowserService
    extends Disposable
    implements ICoreBrowserService
{
    ...
    private readonly _onWindowChange = this.register(
        new EventEmitter<Window & typeof globalThis>()
    );
    ...
    constructor(
        ...
        this.register(
            this.onWindowChange((w) => this._screenDprMonitor.setWindow(w))
        );
        this.register(
            forwardEvent(this._screenDprMonitor.onDprChange, this._onDprChange)
        );
