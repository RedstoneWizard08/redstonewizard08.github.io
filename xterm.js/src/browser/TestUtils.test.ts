...
export class MockTerminal implements ITerminal {
    ...
    public registerBufferElementProvider(
        bufferProvider: IBufferElementProvider
    ): IDisposable {
        throw new Error("Method not implemented.");
    }
...
export class MockBuffer implements IBuffer {
    ...
    public translateBufferLineToString(
        ...
        return Buffer.prototype.translateBufferLineToString.apply(
            this,
            arguments as any
        );
    }
    public getWrappedRangeForLine(y: number): { first: number; last: number } {
        return Buffer.prototype.getWrappedRangeForLine.apply(
            this,
            arguments as any
        );
    }
...
export class MockViewport implements IViewport {
    private readonly _onRequestScrollLines = new EventEmitter<{
        amount: number;
...
export class MockCoreBrowserService implements ICoreBrowserService {
    ...
    public onWindowChange = new EventEmitter<Window & typeof globalThis, void>()
        .event;
...
export class MockRenderService implements IRenderService {
    public serviceBrand: undefined;
    public onDimensionsChange: IEvent<IRenderDimensions> =
        new EventEmitter<IRenderDimensions>().event;
    public onRenderedViewportChange: IEvent<
        { start: number; end: number },
        void
    > = new EventEmitter<{ start: number; end: number }>().event;
    public onRender: IEvent<{ start: number; end: number }, void> =
        new EventEmitter<{ start: number; end: number }>().event;
    public onRefreshRequest: IEvent<{ start: number; end: number }, void> =
        new EventEmitter<{ start: number; end: number }>().event;
...
export class MockSelectionService implements ISelectionService {
    ...
    public onRequestRedraw = new EventEmitter<ISelectionRedrawRequestEvent>()
        .event;
    public onRequestScrollLines =
        new EventEmitter<ISelectionRequestScrollLinesEvent>().event;
