...
export class DomRendererRowFactory {
    ...
    public createRow(
        ...
        for (let x = 0; x < lineLength; x++) {
            ...
            spacing =
                width * cellWidth -
                widthCache.get(chars, cell.isBold(), cell.isItalic());
            ...
            if (cell.isUnderline()) {
                classes.push(
                    `${RowCss.UNDERLINE_CLASS}-${cell.extended.underlineStyle}`
                );
                if (text === " ") {
                    text = "\xa0"; // = &nbsp;
                }
                if (!cell.isUnderlineColorDefault()) {
                    if (cell.isUnderlineColorRGB()) {
                        ...
                        charElement.style.textDecorationColor =
                            colors.ansi[fg].css;
                    }
                }
            }
            ...
            switch (fgColorMode) {
                ...
                case Attributes.CM_RGB:
                    ...
                    if (
                        ...
                        this._addStyle(
                            charElement,
                            `color:#${padStart(fg.toString(16), "0", 6)}`
                        );
                    }
                    break;
                case Attributes.CM_DEFAULT:
