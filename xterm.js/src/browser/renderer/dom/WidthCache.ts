...
export class WidthCache implements IDisposable {
    ...
    public setFont(
        ...
        this._measureElements[FontVariant.REGULAR].style.fontWeight =
            `${weight}`;
        this._measureElements[FontVariant.BOLD].style.fontWeight =
            `${weightBold}`;
        this._measureElements[FontVariant.ITALIC].style.fontWeight =
            `${weight}`;
        this._measureElements[FontVariant.BOLD_ITALIC].style.fontWeight =
            `${weightBold}`;
