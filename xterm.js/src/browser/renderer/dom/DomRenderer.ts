...
export class DomRenderer extends Disposable implements IRenderer {
    ...
    private _selectionRenderModel: ISelectionRenderModel =
        createSelectionRenderModel();

    public dimensions: IRenderDimensions;

    public readonly onRequestRedraw = this.register(
    ...
    constructor(
        ...
        this._rowFactory = instantiationService.createInstance(
            DomRendererRowFactory,
            document
        );
    ...
    public handleSelectionChanged(
        ...
        const viewportCappedEndRow =
            this._selectionRenderModel.viewportCappedEndRow;

        // No need to draw the selection
        if (
            viewportCappedStartRow >= this._bufferService.rows ||
