...
import {
    ...
    IColorZone,
    IColorZoneStore,
} from "browser/decorations/ColorZoneStore";
...
export class OverviewRulerRenderer extends Disposable {
    ...
    private _registerDimensionChangeListeners(): void {
        ...
        this.register(
            this._renderService.onRender((): void => {
                if (
        ...
        this.register(
            this._coreBrowserService.onDprChange(() => this._queueRefresh(true))
        );
    ...
    private _refreshDrawHeightConstants(): void {
        ...
        const nonFullHeight = Math.round(
            Math.max(Math.min(pixelsPerLine, 12), 6) *
    ...
    private _queueRefresh(
        ...
        this._shouldUpdateDimensions =
            updateCanvasDimensions || this._shouldUpdateDimensions;
