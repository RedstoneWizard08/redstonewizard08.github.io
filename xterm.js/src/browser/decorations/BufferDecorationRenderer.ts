...
export class BufferDecorationRenderer extends Disposable {
    ...
    private readonly _decorationElements: Map<
        IInternalDecoration,
        HTMLElement
    > = new Map();
    ...
    private _refreshStyle(decoration: IInternalDecoration): void {
        const line =
            decoration.marker.line - this._bufferService.buffers.active.ydisp;
    ...
    private _refreshXPosition(
        ...
        if ((decoration.options.anchor || "left") === "right") {
            element.style.right = x
                ? `${x * this._renderService.dimensions.css.cell.width}px`
                : "";
        } else {
