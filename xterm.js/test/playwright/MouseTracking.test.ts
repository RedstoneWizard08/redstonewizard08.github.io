...
function parseReport(
    encoding: string,
    msg: number[]
): { state: any; row: number; col: number } | string {
    let sReport: string;
            ...
            await pollFor(ctx.page, () => getReports(encoding), [
                {
                    ...
                    state: {
                        action: "press",
                        button: "left",
                        modifier: { control: false, shift: false, meta: false },
                    },
                },
            ]);
            ...
            await pollFor(ctx.page, () => getReports(encoding), [
                {
                    ...
                    state: {
                        action: "press",
                        button: "left",
                        modifier: { control: true, shift: false, meta: true },
                    },
                },
                {
                    col: 45,
